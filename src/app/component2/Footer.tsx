...
const Footer = () => {
  const storeIcons = ["Blibli", "Lazada", "Shopee", "TikTok", "Tokopedia"];
    ...
    <>
      ...
      <footer className="bg-[#FFF6EF] text-black pt-12">
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6 py-12">
          {/* Info Perusahaan */}
          <div>
            <img src="/logos/yava2.png" alt="YAVA" className="w-40 mb-4" />
            ...
            <div className="flex gap-3 mt-4">
              ...
              <img src="/logos/YouTube.png" alt="YouTube" className="w-8 h-8" />
            </div>
          </div>
